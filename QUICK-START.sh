...
echo ""
echo -e "${GREEN}DEVICE FLEET SETUPS (S10 NetHunter / Oppo / HP Mini G9):${NC}"
echo "  ./MENU  -> option [D]        - Fleet guides + provisioning scripts"
echo "  docs/07_DEVICE_SETUPS/README.md  - Start here"
echo ""
